# -*- coding: utf-8 -*-
"""
Created on Thu Nov 23 15:19:20 2017
...
titanic['Title'] = titanic['Title'].replace(to_replace=['Mme','the Countess'],value='Mrs')
titanic['Title'] = titanic['Title'].replace(to_replace=['Ms','Mlle'],value='Miss')
...
titanic2 = titanic1.drop(['PassengerId','Name','Age','Ticket','SibSp','Parch','Cabin','FamilySize','Survived','Title_Dona','Title_Don','Title_Dr','Title_Lady','Title_Jonkheer'], axis=1, inplace=False)

X_train = titanic2[0:titanic_train.shape[0]]
y_train = titanic_train['Survived']

#oob scrore is computed as part of model construction process
rf_estimator = ensemble.RandomForestClassifier(oob_score=False, random_state=2017)
...
rf_grid = {'n_estimators':[100],'max_features':[5], 'max_depth':[3,4,5,6,7],'verbose':[1]}
