# -*- coding: utf-8 -*-
"""
Created on Thu Nov 16 10:24:51 2017
...
titanic2 = titanic1.drop(['PassengerId','Name','Age','Ticket','Cabin','Survived','FamilySize'], axis=1, inplace=False)
...
grid_tree_estimator2 = model_selection.GridSearchCV(tree_estimator, dt_grid2, cv=8)
...
titanic_test.to_csv('submission_7.csv', columns=['PassengerId','Survived'],index=False)